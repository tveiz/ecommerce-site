...
export default function CheckoutModal({ product, onClose }: CheckoutModalProps) {
  ...
  const handleApplyCoupon = () => {
    if (coupon.toLowerCase() === 'desconto10') {
      ...
      if (typeof window !== 'undefined') {
        window.alert('Cupom aplicado: 10% de desconto!');
      }
    } else {
      if (typeof window !== 'undefined') {
        window.alert('Cupom inválido ou expirado.');
      }
    }
  };
  ...
  const handleCheckout = async () => {
    if (step === 1) {
      ...
      if (typeof window !== 'undefined') {
        window.alert(`Compra realizada com sucesso! Método: ${paymentMethod}`);
      }
      onClose();
    }
  };
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              {step === 1 ? (
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="px-4 py-2 rounded-lg font-medium bg-orange-600 text-white"
                      >
                        Aplicar
                      </button>
                    </div>
                ...
                <>
                  {/* Etapa 2: Confirmação */}
                  <div className="mb-6 p-4 rounded-lg border border-orange-200">
              ...
              <div className="flex gap-4 pt-6">
                ...
                <button
                  ...
                  className="flex-1 py-3 rounded-lg font-bold text-white bg-orange-600"
                >
